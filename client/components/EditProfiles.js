...
export const EditProfileEP = () => {
    ...
    React.useEffect(() => {
        axios
            .get(
                `http://192.168.11.97:3000/Users/ServiceProvider/Fetch/${userData._id}`
            )
            .then((res) => {
                const data = res.data;
                setData(data);
    ...
    const update = () => {
        ...
        axios
            .put(
                `http://192.168.11.97:3000/Users/ServiceProvider/Update/${userID}`,
                updateData
            )
            .then((res) => {
    ...
    const updatePassword = () => {
        ...
        axios
            .put(
                `http://192.168.11.97:3000/Users/ServiceProvider/UpdatePassword/${userID}`,
                updateData
            )
            .then((res) => {
...
export const EditProfileSS = () => {
    ...
    React.useEffect(() => {
        axios
            .get(
                `http://192.168.11.97:3000/Users/ServiceSeeker/Fetch/${userData._id}`
            )
            .then((res) => {
                const data = res.data;
                setData(data);
    ...
    const update = () => {
        ...
        axios
            .put(
                `http://192.168.11.97:3000/Users/ServiceSeeker/Update/${userID}`,
                updateData
            )
            .then((res) => {
                if (res.data === "Email adress already exists") {
    ...
    const updatePassword = () => {
        ...
        axios
            .put(
                `http://192.168.11.97:3000/Users/ServiceSeeker/UpdatePassword/${userID}`,
                updateData
            )
            .then((res) => {
                if (res.data === "Wrong Password !!") {
