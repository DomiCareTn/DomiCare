    ...
    useEffect(async () => {
        try {
            ...
            const post = await axios.get(
                `http://192.168.164.81:3000/post/findpost/${_id}`
            );
            const com = await axios.get(
                `http://192.168.164.81:3000/post/findcomments/${_id}`
            );
            setpost(post.data);
    ...
    const Comment = async () => {
        try {
            ...
            const comment = await axios.post(
                `http://192.168.164.81:3000/post/createComment/${postOwner}`,
                { obj }
            );
            setValue("");
    ...
    const replyto = async () => {
        try {
            ...
            const reply = await axios.post(
                `http://192.168.164.81:3000/post/reply`,
                {
                    rep: {
    ...
    const Like = async () => {
        ...
        try {
            ...
            const post = await axios.put(
                `http://192.168.164.81:3000/post/savepost`,
                {
                    userid,
                    postid,
                    action,
    ...
    const DeleteAlert = (id) =>
        Alert.alert("Alert!", "Are you sure you want to delete this post?", [
            ...
            },
            {
                ...
                onPress: () => {
                    axios
                        .delete(`http://192.168.164.81:3000/post/Delete/${id}`)
        ...
        Alert.alert("Alert!", "Are you sure you want to delete this comment?", [
            ...
            },
            {
                ...
                onPress: () => {
                    ...
                    axios
                        .delete(
                            `http://192.168.164.81:3000/post/deleteComment/${id}/${postID}`
                        )
