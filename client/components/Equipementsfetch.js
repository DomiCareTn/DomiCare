...
const Equipementsfetch = () => {
    ...
    //  var fetchData=()=>{
    //     fetch("http://192.168.121.162:3000/Equipements")
    //     .then(response=>{
    ...
    var apihandler = () => {
        const url = "http://192.168.121.162:3000/Equipements";
        fetch(url)
            .then((res) => res.json())
            .then((resJson) => {
