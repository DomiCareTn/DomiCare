...
const userEquipements = ({ navigation }) => {
    ...
    useEffect(() => {
        axios
            .get(
                `http://192.168.164.81:3000/Equipements/${userData.userData._id}`
            )
            .then((res) => {
                setmyData(res.data);
    ...
    const getEquip = () => {
        axios
            .get(
                `http://192.168.164.81:3000/Equipements/equip/${formData._id}`
            )
            .then((res) => {
    ...
    const saveEquipement = () => {
        ...
        axios
            .post(`http://192.168.164.81:3000/Equipements/saveEquip`, {
                formData,
            })
            .then((response) => {
    ...
    const myDelete = () => {
        console.log("ownerId", formData.ownerId);
        axios
            .delete(`http://192.168.164.81:3000/Equipements/${myData.ownerId}`)
            .catch((error) => {
                console.log(error);
            });
    };
